...
final class ZonedDateTimeLocalComponentsTest extends TemporalTestCase
{
    public function testUtcLocalComponents(): void
    {
        ...
        $this->assertPlainDateTimeIs(2020, 1, 15, 12, 30, 45, 123, 456, 789, $zdt->toPlainDateTime());
    ...
    public function testPositiveFixedOffsetLocalComponents(): void
    {
        ...
        $this->assertPlainDateTimeIs(1970, 1, 1, 5, 30, 0, 0, 0, 0, $zdt->toPlainDateTime());
    ...
    public function testNegativeFixedOffsetLocalComponents(): void
    {
        ...
        $this->assertPlainDateTimeIs(1969, 12, 31, 19, 0, 0, 0, 0, 0, $zdt->toPlainDateTime());
