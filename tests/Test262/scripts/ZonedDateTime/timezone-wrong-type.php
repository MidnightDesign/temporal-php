...
Assert::throws((is_string($timeZone) ? \InvalidArgumentException::class : \TypeError::class), fn() => new \Temporal\ZonedDateTime(0, $timeZone), "{$description} does not convert to a valid ISO string");
}
