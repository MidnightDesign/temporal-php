...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Temporal\Spec\ZonedDateTime::from($arg); }, "\"{$arg}\" UTC offset without time is not valid for ZonedDateTime");
}
