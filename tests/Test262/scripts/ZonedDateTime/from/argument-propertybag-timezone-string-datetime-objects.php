...
Assert::throws(\InvalidArgumentException::class, function () use (&$timeZone) { return \Temporal\Spec\ZonedDateTime::from((object) ['year' => 2000, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]); }, 'bare date-time string is not a time zone');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$timeZone) { return \Temporal\Spec\ZonedDateTime::from((object) ['year' => 2000, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]); }, "ISO string {$timeZone} with a sub-minute offset is not a valid time zone");
}
$timeZone = '2021-08-19T17:30Z';
$result1 = \Temporal\Spec\ZonedDateTime::from((object) ['year' => 2000, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]);
Assert::sameValue($result1->timeZoneId, 'UTC', 'date-time + Z is UTC time zone');
$timeZone = '2021-08-19T17:30-07:00';
$result2 = \Temporal\Spec\ZonedDateTime::from((object) ['year' => 2000, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]);
Assert::sameValue($result2->timeZoneId, '-07:00', 'date-time + offset is the offset time zone');
$timeZone = '2021-08-19T17:30[UTC]';
$result3 = \Temporal\Spec\ZonedDateTime::from((object) ['year' => 2000, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]);
Assert::sameValue($result3->timeZoneId, 'UTC', 'date-time + IANA annotation is the IANA time zone');
$timeZone = '2021-08-19T17:30Z[UTC]';
$result4 = \Temporal\Spec\ZonedDateTime::from((object) ['year' => 2000, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]);
...
$result5 = \Temporal\Spec\ZonedDateTime::from((object) ['year' => 2000, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]);
