...
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\ZonedDateTime::from(['year' => 2000, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]), 'leap second in time zone name not valid');
