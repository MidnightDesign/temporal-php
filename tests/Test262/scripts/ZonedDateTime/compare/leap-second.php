...
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\ZonedDateTime::compare($arg, $datetime), 'leap second in time zone name not valid (first argument)');
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\ZonedDateTime::compare($datetime, $arg), 'leap second in time zone name not valid (second argument)');
