...
Assert::throws(\RangeException::class, function () use (&$arg, &$datetime) { return \Temporal\Spec\ZonedDateTime::compare($arg, $datetime); }, 'calendar ID is capital dotted I is not lowercased (first argument)');
Assert::throws(\RangeException::class, function () use (&$datetime, &$arg) { return \Temporal\Spec\ZonedDateTime::compare($datetime, $arg); }, 'calendar ID is capital dotted I is not lowercased (second argument)');
