...
$result = \Temporal\Spec\ZonedDateTime::compare($arg, $arg);
...
Assert::throws(\RangeException::class, function () use (&$arg, &$datetime) { return \Temporal\Spec\ZonedDateTime::compare($arg, $datetime); }, "\"{$arg}\" UTC offset without time is not valid for ZonedDateTime (first argument)");
Assert::throws(\RangeException::class, function () use (&$datetime, &$arg) { return \Temporal\Spec\ZonedDateTime::compare($datetime, $arg); }, "\"{$arg}\" UTC offset without time is not valid for ZonedDateTime (second argument)");
}
