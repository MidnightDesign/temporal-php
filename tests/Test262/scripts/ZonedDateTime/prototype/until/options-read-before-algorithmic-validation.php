...
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$other, &$options) { $instance->until($other, $options); }, 'exception thrown when smallestUnit > largestUnit');
