...
Assert::throws(\InvalidArgumentException::class, fn() => $instance1->until(['year' => 2020, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]), "ISO string {$timeZone} with a sub-minute offset is not a valid time zone");
}
