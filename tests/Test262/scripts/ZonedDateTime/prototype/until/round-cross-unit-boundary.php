...
$earlier = new \Temporal\ZonedDateTime(1_640_995_200_000_000_000, 'UTC');
$later = new \Temporal\ZonedDateTime(1_703_462_400_000_000_000, 'UTC');
...
$later = new \Temporal\ZonedDateTime(7_199_000_000_000, 'UTC');
...
$earlier = new \Temporal\ZonedDateTime(0, 'UTC');
$later = new \Temporal\ZonedDateTime(63_071_999_999_999_999, 'UTC');
