...
Assert::throws((is_string($timeZone) ? \InvalidArgumentException::class : \TypeError::class), fn() => $instance->withTimeZone($timeZone), "{$description} does not convert to a valid ISO string");
}
