...
Assert::throws((is_string($timeZone) ? \InvalidArgumentException::class : \TypeError::class), function () use (&$instance, &$timeZone) { return $instance->withTimeZone($timeZone); }, "{$description} does not convert to a valid ISO string");
}
