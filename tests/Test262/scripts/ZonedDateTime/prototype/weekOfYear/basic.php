...
for ($i = 29; $i <= 31; ++$i) {
$zdt = new \Temporal\Spec\PlainDateTime(1975, 12, $i, 15, 23, 30, 123, 456, 789)->toZonedDateTime('UTC');
Assert::sameValue($zdt->weekOfYear, 1, "{$zdt} should be in week 1");
}
for ($i = 1; $i <= 4; ++$i) {
$zdt = new \Temporal\Spec\PlainDateTime(1976, 1, $i, 15, 23, 30, 123, 456, 789)->toZonedDateTime('UTC');
Assert::sameValue($zdt->weekOfYear, 1, "{$zdt} should be in week 1");
}
for ($i = 5; $i <= 11; ++$i) {
$zdt = new \Temporal\Spec\PlainDateTime(1976, 1, $i, 15, 23, 30, 123, 456, 789)->toZonedDateTime('UTC');
...
for ($i = 20; $i <= 26; ++$i) {
$zdt = new \Temporal\Spec\PlainDateTime(1976, 12, $i, 15, 23, 30, 123, 456, 789)->toZonedDateTime('UTC');
...
for ($i = 1; $i <= 2; ++$i) {
$zdt = new \Temporal\Spec\PlainDateTime(1977, 1, $i, 15, 23, 30, 123, 456, 789)->toZonedDateTime('UTC');
Assert::sameValue($zdt->weekOfYear, 53, "{$zdt} should be in week 53");
}
