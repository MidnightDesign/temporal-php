...
Assert::throws((is_string($timeZone) ? \InvalidArgumentException::class : \TypeError::class), fn() => $instance->equals(['year' => 2020, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]), "{$description} does not convert to a valid ISO string");
}
