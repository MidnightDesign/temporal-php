...
Assert::throws(\InvalidArgumentException::class, fn() => $instance->equals($str), 'date-time + Z is not a ZonedDateTime');
$str = '1970-01-01T00:00+01:00';
Assert::throws(\InvalidArgumentException::class, fn() => $instance->equals($str), 'date-time + offset is not a ZonedDateTime');
$str = '1970-01-01T00:00[+01:00]';
...
Assert::throws(\InvalidArgumentException::class, fn() => $instance->equals($str), 'date-time + offset + IANA annotation throws if wall time and exact time mismatch');
