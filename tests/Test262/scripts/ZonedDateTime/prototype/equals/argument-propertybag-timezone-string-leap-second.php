...
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$timeZone) { return $instance->equals(['year' => 2020, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]); }, 'leap second in time zone name not valid');
