...
Assert::throws((is_string($timeZone) ? \InvalidArgumentException::class : \TypeError::class), function () use (&$instance, &$timeZone) { return $instance->since((object) ['year' => 2020, 'month' => 5, 'day' => 2, 'timeZone' => $timeZone]); }, "{$description} does not convert to a valid ISO string");
}
