...
TemporalHelpers::assertDurationsEqual($earlier->since($later, (object) ['largestUnit' => $largestUnit]), $diff->negated());
TemporalHelpers::assertDurationsEqual($earlier->until($later, (object) ['largestUnit' => $largestUnit]), $diff);
...
$diff1 = $earlier->until($later, (object) ['largestUnit' => $largestUnit]);
$diff2 = $later->since($earlier, (object) ['largestUnit' => $largestUnit]);
