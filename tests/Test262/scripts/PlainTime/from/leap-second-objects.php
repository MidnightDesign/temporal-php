...
$result1 = \Temporal\Spec\PlainTime::from($arg);
TemporalHelpers::assertPlainTime($result1, 23, 59, 59, 0, 0, 0, 'leap second is a valid ISO string for PlainTime');
$result2 = \Temporal\Spec\PlainTime::from($arg, (object) ['overflow' => 'reject']);
...
Assert::throws(\InvalidArgumentException::class, function () use (&$arg) { return \Temporal\Spec\PlainTime::from($arg, (object) ['overflow' => 'reject']); }, 'second: 60 is rejected in property bag for PlainTime with overflow: reject');
