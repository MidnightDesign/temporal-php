...
Assert::throws(\InvalidArgumentException::class, function () use (&$time) { return $time->toString(['fractionalSecondDigits' => -0.6]); }, 'fractionalSecondDigits -0.6 floors to -1 and is out of range');
