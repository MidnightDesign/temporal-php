...
Assert::throws(\InvalidArgumentException::class, function () use (&$time, &$smallestUnit) { return $time->toString(JsUndefined::strip(['smallestUnit' => $smallestUnit])); }, "\"{$smallestUnit}\" is not a valid unit for the smallestUnit option");
}
