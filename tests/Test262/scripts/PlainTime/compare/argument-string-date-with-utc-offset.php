...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Temporal\Spec\PlainTime::compare($arg, new \Temporal\Spec\PlainTime(12, 34, 56, 987, 654, 321)); }, "\"{$arg}\" UTC offset without time is not valid for PlainTime (first argument)");
Assert::throws(\RangeException::class, function () use (&$arg) { return \Temporal\Spec\PlainTime::compare(new \Temporal\Spec\PlainTime(12, 34, 56, 987, 654, 321), $arg); }, "\"{$arg}\" UTC offset without time is not valid for PlainTime (second argument)");
}
