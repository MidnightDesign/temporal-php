...
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\PlainTime::compare($arg, new \Temporal\PlainTime(12, 34, 56, 987, 654, 321)), "annotation keys must be lowercase: {$arg} - {$descr} (first argument)");
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\PlainTime::compare(new \Temporal\PlainTime(12, 34, 56, 987, 654, 321), $arg), "annotation keys must be lowercase: {$arg} - {$descr} (second argument)");
}
