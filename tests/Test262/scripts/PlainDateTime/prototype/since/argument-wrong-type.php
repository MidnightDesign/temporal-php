...
Assert::throws((is_string($arg) ? \InvalidArgumentException::class : \TypeError::class), function () use (&$instance, &$arg) { return $instance->since($arg); }, "{$description} does not convert to a valid ISO string");
}
