...
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$arg) { return $instance->since($arg); }, "\"{$arg}\" is outside the representable range of PlainDateTime");
}
