...
$result = $dt1->since($dt2, (object) ['largestUnit' => 'microseconds']);
...
Assert::sameValue(\Temporal\Spec\Duration::compare($result->add((object) ['microseconds' => 1]), $result), 0, 'subsequent ops on duration should not use more precise internal representation than the spec prescribes');
