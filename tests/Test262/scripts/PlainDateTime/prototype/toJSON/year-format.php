...
$instance = new \Temporal\PlainDateTime(-100_000, 12, 3, 4, 56, 7, 890);
Assert::sameValue($instance->toJSON(), '-100000-12-03T04:56:07.89', 'large negative year formatted as 6-digit');
$instance = new \Temporal\PlainDateTime(-10_000, 4, 5, 6, 7, 8, 910);
...
$instance = new \Temporal\PlainDateTime(10_000, 6, 7, 8, 9, 10, 987);
Assert::sameValue($instance->toJSON(), '+010000-06-07T08:09:10.987', 'smallest 5-digit positive year formatted as 6-digit');
$instance = new \Temporal\PlainDateTime(100_000, 8, 9, 10, 9, 8, 765);
