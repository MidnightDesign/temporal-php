...
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$field, &$overflow) { return $instance->add((object) JsUndefined::strip([$field => INF]), (object) JsUndefined::strip(['overflow' => $overflow])); }, '');
}
}
$calls = 0;
