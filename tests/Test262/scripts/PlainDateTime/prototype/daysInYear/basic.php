...
Assert::sameValue(new \Temporal\PlainDateTime(1976, 11, 18, 15, 23, 30, 123, 456, 789)->daysInYear, 366, 'leap year');
Assert::sameValue(new \Temporal\PlainDateTime(1977, 11, 18, 15, 23, 30, 123, 456, 789)->daysInYear, 365, 'non-leap year');
