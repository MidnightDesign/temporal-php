...
$µs = $µs ?? 0;
$ns = $ns ?? 0;
TemporalHelpers::assertPlainDateTime($instance->round((object) ['smallestUnit' => $smallestUnit, 'roundingMode' => $roundingMode]), $y, $mon, $mc, $d, $h, $min, $s, $ms, $µs, $ns, "rounds to {$smallestUnit} (roundingMode = {$roundingMode})");
}
