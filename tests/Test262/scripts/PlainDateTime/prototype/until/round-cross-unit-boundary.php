...
$earlier = new \Temporal\Spec\PlainDateTime(2022, 1, 1);
$later = new \Temporal\Spec\PlainDateTime(2023, 12, 25);
...
$earlier = new \Temporal\Spec\PlainDateTime(2000, 5, 2);
$later = new \Temporal\Spec\PlainDateTime(2000, 5, 2, 1, 59, 59);
...
$earlier = new \Temporal\Spec\PlainDateTime(1970, 1, 1);
$later = new \Temporal\Spec\PlainDateTime(1971, 12, 31, 23, 59, 59, 999, 999, 999);
