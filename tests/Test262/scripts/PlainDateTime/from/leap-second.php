...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Temporal\Spec\PlainDateTime::from($arg, ['overflow' => 'reject']); }, 'second: 60 is rejected in property bag for PlainDateTime with overflow: reject');
