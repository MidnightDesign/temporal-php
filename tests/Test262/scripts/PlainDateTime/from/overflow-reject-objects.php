...
Assert::throws(\RangeException::class, fn() => \Temporal\Spec\PlainDateTime::from((object) ['year' => 2019, 'month' => 1, 'day' => 32], (object) ['overflow' => 'reject']), 'overflow reject, unacceptable argument');
