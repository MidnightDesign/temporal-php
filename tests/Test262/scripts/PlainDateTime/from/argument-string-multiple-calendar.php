...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Temporal\Spec\PlainDateTime::from($arg); }, "reject more than one calendar annotation if any critical: {$arg}");
}
