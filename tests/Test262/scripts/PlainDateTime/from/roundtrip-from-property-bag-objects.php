...
$dateFromYearMonth = \Temporal\Spec\PlainDateTime::from((object) ['year' => $year, 'month' => $month, 'day' => $day, 'hour' => 12, 'minute' => 34, 'second' => 56, 'millisecond' => 987, 'microsecond' => 654, 'nanosecond' => 321], $options);
...
$dateFromYearMonthCode = \Temporal\Spec\PlainDateTime::from((object) ['year' => $year, 'monthCode' => $monthCode, 'day' => $day, 'hour' => 12, 'minute' => 34, 'second' => 56, 'millisecond' => 987, 'microsecond' => 654, 'nanosecond' => 321], $options);
