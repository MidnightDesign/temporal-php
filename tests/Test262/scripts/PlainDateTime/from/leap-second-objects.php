...
$result1 = \Temporal\Spec\PlainDateTime::from($arg);
...
$result2 = \Temporal\Spec\PlainDateTime::from($arg);
...
Assert::throws(\InvalidArgumentException::class, function () use (&$arg) { return \Temporal\Spec\PlainDateTime::from($arg, (object) ['overflow' => 'reject']); }, 'second: 60 is rejected in property bag for PlainDateTime with overflow: reject');
