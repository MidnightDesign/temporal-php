...
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Spec\PlainDateTime::compare(array_merge($base, [$prop => $inf]), $other), "{$prop} property cannot be {$inf}");
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Spec\PlainDateTime::compare($other, array_merge($base, [$prop => $inf])), "{$prop} property cannot be {$inf}");
$calls1 = [];
