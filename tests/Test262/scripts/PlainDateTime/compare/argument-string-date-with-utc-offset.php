...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Temporal\Spec\PlainDateTime::compare($arg, new \Temporal\Spec\PlainDateTime(1976, 11, 18)); }, "\"{$arg}\" UTC offset without time is not valid for PlainDateTime (first argument)");
Assert::throws(\RangeException::class, function () use (&$arg) { return \Temporal\Spec\PlainDateTime::compare(new \Temporal\Spec\PlainDateTime(1976, 11, 18), $arg); }, "\"{$arg}\" UTC offset without time is not valid for PlainDateTime (second argument)");
}
