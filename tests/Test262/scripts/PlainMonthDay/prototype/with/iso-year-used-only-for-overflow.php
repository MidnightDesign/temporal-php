...
Assert::throws(\InvalidArgumentException::class, function () use (&$leap, &$outOfRangeCommonYear) { $leap->with(JsUndefined::strip(['year' => $outOfRangeCommonYear]), ['overflow' => 'reject']); }, 'ISO year is used to apply overflow');
