...
Assert::throws(\TypeError::class, function () use (&$value) { return \Temporal\Spec\PlainMonthDay::from((object) ['monthCode' => 'M12', 'day' => 15], $value); }, "TypeError on wrong options type " . (gettype($value)) . "");
