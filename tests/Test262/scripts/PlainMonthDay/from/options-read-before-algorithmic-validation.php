...
Assert::throws(\InvalidArgumentException::class, function () use (&$options) { \Temporal\Spec\PlainMonthDay::from(['monthCode' => 'M08L', 'day' => 14], $options); }, 'exception thrown when month code is invalid for calendar');
