...
$result = \Temporal\Spec\PlainMonthDay::from((object) ['year' => 2021, 'month' => 7, 'day' => 3], $opt);
TemporalHelpers::assertPlainMonthDay($result, 'M07', 3, "month 7, day 3, with year, options = {$optionsDesc}");
$result = \Temporal\Spec\PlainMonthDay::from((object) ['year' => 2021, 'month' => 12, 'day' => 31], $opt);
TemporalHelpers::assertPlainMonthDay($result, 'M12', 31, "month 12, day 31, with year, options = {$optionsDesc}");
$result = \Temporal\Spec\PlainMonthDay::from((object) ['monthCode' => 'M07', 'day' => 3], $opt);
