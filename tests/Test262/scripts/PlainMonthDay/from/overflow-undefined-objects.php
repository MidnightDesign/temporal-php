...
$explicit = \Temporal\Spec\PlainMonthDay::from($value, (object) []);
TemporalHelpers::assertPlainMonthDay($explicit, 'M05', 2, 'overflow is ignored');
$implicit = \Temporal\Spec\PlainMonthDay::from($value, (object) []);
...
$explicit = \Temporal\Spec\PlainMonthDay::from($propertyBag, (object) []);
TemporalHelpers::assertPlainMonthDay($explicit, 'M12', 31, 'default overflow is constrain');
$implicit = \Temporal\Spec\PlainMonthDay::from($propertyBag, (object) []);
