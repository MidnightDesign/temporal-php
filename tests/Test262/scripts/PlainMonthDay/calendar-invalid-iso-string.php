...
Assert::throws(\InvalidArgumentException::class, function () use (&$arg) { return new \Temporal\Spec\PlainMonthDay(12, 15, $arg, 1972); }, "{$description} is not a valid calendar ID");
}
