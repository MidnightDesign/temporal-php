...
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Instant::compare($str, $epoch), 'bare date-time string is not an instant (first argument)');
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Instant::compare($epoch, $str), 'bare date-time string is not an instant (second argument)');
$str = '1970-01-01T00:00[UTC]';
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Instant::compare($str, $epoch), 'date-time + IANA annotation is not an instant (first argument)');
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Instant::compare($epoch, $str), 'date-time + IANA annotation is not an instant (second argument)');
