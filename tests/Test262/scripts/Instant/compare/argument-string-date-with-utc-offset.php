...
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Instant::compare($arg, $epoch), "\"{$arg}\" UTC offset without time is not valid for Instant (first argument)");
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Instant::compare($epoch, $arg), "\"{$arg}\" UTC offset without time is not valid for Instant (second argument)");
}
