...
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Instant::compare($arg, $instance), "\"{$arg}\" is outside the representable range of Instant (first argument)");
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Instant::compare($instance, $arg), "\"{$arg}\" is outside the representable range of Instant (second argument)");
}
