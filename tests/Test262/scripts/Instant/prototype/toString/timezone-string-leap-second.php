...
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$timeZone) { return $instance->toString(JsUndefined::strip(['timeZone' => $timeZone])); }, 'leap second in time zone name not valid');
