...
Assert::throws(\InvalidArgumentException::class, function () use (&$instant, &$smallestUnit) { return $instant->toString((object) ['smallestUnit' => $smallestUnit]); }, "\"{$smallestUnit}\" is not a valid unit for the smallestUnit option");
}
