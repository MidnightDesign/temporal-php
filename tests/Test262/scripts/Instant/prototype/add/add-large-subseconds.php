...
Assert::throws(\InvalidArgumentException::class, fn() => $i1->add(\Temporal\Duration::from(['milliseconds' => -$bigNumber])), '');
Assert::throws(\InvalidArgumentException::class, fn() => $i1->add(\Temporal\Duration::from(['microseconds' => $bigNumber])), '');
Assert::throws(\InvalidArgumentException::class, fn() => $i1->add(\Temporal\Duration::from(['microseconds' => -$bigNumber])), '');
$i2 = new \Temporal\Instant(0);
Assert::sameValue($i2->add(\Temporal\Duration::from(['nanoseconds' => $bigNumber]))->epochNanoseconds, 9_007_199_254_740_990_976, '');
Assert::sameValue($i2->add(\Temporal\Duration::from(['nanoseconds' => -$bigNumber]))->epochNanoseconds, -9_007_199_254_740_990_976, '');
Assert::throws(\InvalidArgumentException::class, fn() => $i2->add(\Temporal\Duration::from(['milliseconds' => $bigNumber])), '');
Assert::throws(\InvalidArgumentException::class, fn() => $i2->add(\Temporal\Duration::from(['milliseconds' => -$bigNumber])), '');
Assert::throws(\InvalidArgumentException::class, fn() => $i2->add(\Temporal\Duration::from(['microseconds' => $bigNumber])), '');
Assert::throws(\InvalidArgumentException::class, fn() => $i2->add(\Temporal\Duration::from(['microseconds' => -$bigNumber])), '');
