...
Assert::sameValue($i1->add(\Temporal\Spec\Duration::from((object) JsUndefined::strip(['nanoseconds' => 9_007_199_254_740_991])))->epochNanoseconds, 1_591_973_847_002_353_569, '');
Assert::sameValue($i1->add(\Temporal\Spec\Duration::from((object) JsUndefined::strip(['nanoseconds' => -9_007_199_254_740_991])))->epochNanoseconds, 1_573_959_448_492_871_587, '');
// SKIP (int64 overflow): Assert::sameValue($i1->add(\Temporal\Spec\Duration::from((object) JsUndefined::strip(['microseconds' => 9_007_199_254_740_991])))->epochNanoseconds, 10590165902488603578, ...);
