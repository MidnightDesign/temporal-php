...
TemporalHelpers::checkPluralUnitsAccepted(function ($smallestUnit) use (&$earlier, &$later) { return $earlier->until($later, (object) ['smallestUnit' => $smallestUnit]); }, $validUnits);
