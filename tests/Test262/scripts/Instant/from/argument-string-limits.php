...
\Temporal\Spec\Instant::from($arg);
}
...
Assert::throws(\InvalidArgumentException::class, function () use (&$arg) { return \Temporal\Spec\Instant::from($arg); }, "\"{$arg}\" is outside the representable range of Instant");
}
