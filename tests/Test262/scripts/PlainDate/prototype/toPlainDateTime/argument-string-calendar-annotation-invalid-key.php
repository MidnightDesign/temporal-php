...
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$arg) { return $instance->toPlainDateTime($arg); }, "annotation keys must be lowercase: {$arg} - {$descr}");
}
