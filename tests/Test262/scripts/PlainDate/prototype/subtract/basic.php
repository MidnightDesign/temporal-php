...
TemporalHelpers::assertPlainDate(\Temporal\Spec\PlainDate::from('2019-02-28')->subtract(['months' => 1]), 2019, 1, 'M01', 28);
TemporalHelpers::assertPlainDate($date->subtract(\Temporal\Spec\Duration::from('P43Y')), 1976, 11, 'M11', 18);
TemporalHelpers::assertPlainDate(\Temporal\Spec\PlainDate::from('1976-11-18')->subtract(JsUndefined::strip(['years' => -43])), 2019, 11, 'M11', 18);
TemporalHelpers::assertPlainDate(\Temporal\Spec\PlainDate::from('2018-12-18')->subtract(JsUndefined::strip(['months' => -11])), 2019, 11, 'M11', 18);
TemporalHelpers::assertPlainDate(\Temporal\Spec\PlainDate::from('2019-10-29')->subtract(JsUndefined::strip(['days' => -20])), 2019, 11, 'M11', 18);
TemporalHelpers::assertPlainDate(\Temporal\Spec\PlainDate::from('2019-01-28')->subtract(JsUndefined::strip(['months' => -1])), 2019, 2, 'M02', 28);
