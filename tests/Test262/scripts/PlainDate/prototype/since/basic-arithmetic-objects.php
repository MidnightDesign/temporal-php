...
$date00011225 = \Temporal\Spec\PlainDate::from('0001-12-25');
$date19600216 = \Temporal\Spec\PlainDate::from('1960-02-16');
$date19600330 = \Temporal\Spec\PlainDate::from('1960-03-30');
$date19690724 = new \Temporal\Spec\PlainDate(1969, 7, 24);
$date19970616 = \Temporal\Spec\PlainDate::from('1997-06-16');
$date19970716 = \Temporal\Spec\PlainDate::from('1997-07-16');
$date19971216 = \Temporal\Spec\PlainDate::from('1997-12-16');
$date19971230 = \Temporal\Spec\PlainDate::from('1997-12-30');
$date20110716 = \Temporal\Spec\PlainDate::from('2011-07-16');
$date20190101 = \Temporal\Spec\PlainDate::from('2019-01-01');
$date20190201 = \Temporal\Spec\PlainDate::from('2019-02-01');
$date20190724 = \Temporal\Spec\PlainDate::from((object) ['year' => 2019, 'month' => 7, 'day' => 24]);
$date20191230 = \Temporal\Spec\PlainDate::from('2019-12-30');
$date20200201 = \Temporal\Spec\PlainDate::from('2020-02-01');
$date20200315 = \Temporal\Spec\PlainDate::from('2020-03-15');
$date20200316 = \Temporal\Spec\PlainDate::from('2020-03-16');
$date20200330 = \Temporal\Spec\PlainDate::from('2020-03-30');
$date20201216 = \Temporal\Spec\PlainDate::from('2020-12-16');
$date20201230 = \Temporal\Spec\PlainDate::from('2020-12-30');
$date20210105 = \Temporal\Spec\PlainDate::from('2021-01-05');
$date20210107 = \Temporal\Spec\PlainDate::from('2021-01-07');
$date20210116 = \Temporal\Spec\PlainDate::from('2021-01-16');
$date20210201 = \Temporal\Spec\PlainDate::from('2021-02-01');
$date20210205 = \Temporal\Spec\PlainDate::from('2021-02-05');
$date20210228 = new \Temporal\Spec\PlainDate(2021, 2, 28);
$date20210305 = \Temporal\Spec\PlainDate::from('2021-03-05');
$date20210307 = \Temporal\Spec\PlainDate::from('2021-03-07');
$date20210315 = \Temporal\Spec\PlainDate::from('2021-03-15');
$date20210330 = \Temporal\Spec\PlainDate::from('2021-03-30');
$date20210615 = \Temporal\Spec\PlainDate::from('2021-06-15');
$date20210713 = \Temporal\Spec\PlainDate::from('2021-07-13');
$date20210715 = \Temporal\Spec\PlainDate::from('2021-07-15');
$date20210716 = \Temporal\Spec\PlainDate::from('2021-07-16');
$date20210717 = \Temporal\Spec\PlainDate::from('2021-07-17');
$date20210723 = \Temporal\Spec\PlainDate::from('2021-07-23');
$date20210813 = \Temporal\Spec\PlainDate::from('2021-08-13');
$date20210816 = \Temporal\Spec\PlainDate::from('2021-08-16');
$date20210817 = \Temporal\Spec\PlainDate::from('2021-08-17');
$date20210916 = \Temporal\Spec\PlainDate::from('2021-09-16');
$date20210921 = \Temporal\Spec\PlainDate::from('2021-09-21');
$date20211017 = \Temporal\Spec\PlainDate::from('2021-10-17');
$date20220228 = new \Temporal\Spec\PlainDate(2022, 2, 28);
$date20220716 = \Temporal\Spec\PlainDate::from('2022-07-16');
$date20220719 = \Temporal\Spec\PlainDate::from('2022-07-19');
$date20220919 = \Temporal\Spec\PlainDate::from('2022-09-19');
$date20221017 = \Temporal\Spec\PlainDate::from('2022-10-17');
$date20310716 = \Temporal\Spec\PlainDate::from('2031-07-16');
$date20311216 = \Temporal\Spec\PlainDate::from('2031-12-16');
...
TemporalHelpers::assertDuration($one->since($two, (object) ['largestUnit' => $largestUnit]), $neg($years), $neg($months), $neg($weeks), $neg($days), 0, 0, 0, 0, 0, 0, $descr);
}
}
