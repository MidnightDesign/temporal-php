...
$date = \Temporal\PlainDate::from('1976-11-18');
...
TemporalHelpers::assertPlainDate(\Temporal\PlainDate::from('2019-01-31')->add(['months' => 1]), 2019, 2, 'M02', 28);
TemporalHelpers::assertPlainDate($date->add(\Temporal\Duration::from('P43Y')), 2019, 11, 'M11', 18);
TemporalHelpers::assertPlainDate(\Temporal\PlainDate::from('2019-11-18')->add(['years' => -43]), 1976, 11, 'M11', 18);
TemporalHelpers::assertPlainDate(\Temporal\PlainDate::from('1977-02-18')->add(['months' => -3]), 1976, 11, 'M11', 18);
TemporalHelpers::assertPlainDate(\Temporal\PlainDate::from('1976-12-08')->add(['days' => -20]), 1976, 11, 'M11', 18);
TemporalHelpers::assertPlainDate(\Temporal\PlainDate::from('2019-02-28')->add(['months' => -1]), 2019, 1, 'M01', 28);
$p1y = new \Temporal\Duration(1);
$p4y = new \Temporal\Duration(4);
$p5m = new \Temporal\Duration(0, 5);
$p1y2m = new \Temporal\Duration(1, 2);
$p1y4d = new \Temporal\Duration(1, 0, 0, 4);
$p1y2m4d = new \Temporal\Duration(1, 2, 0, 4);
$p10d = new \Temporal\Duration(0, 0, 0, 10);
$p1w = new \Temporal\Duration(0, 0, 1);
$p6w = new \Temporal\Duration(0, 0, 6);
$p2w3d = new \Temporal\Duration(0, 0, 2, 3);
$p1y2w = new \Temporal\Duration(1, 0, 2);
$p2m3w = new \Temporal\Duration(0, 2, 3);
