...
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$arg) { return $instance->toZonedDateTime((object) ['plainTime' => $arg, 'timeZone' => 'UTC']); }, "reject more than one calendar annotation if any critical: {$arg}");
}
