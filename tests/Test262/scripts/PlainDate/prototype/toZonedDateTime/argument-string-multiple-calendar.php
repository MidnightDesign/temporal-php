...
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$arg) { return $instance->toZonedDateTime(['plainTime' => $arg, 'timeZone' => 'UTC']); }, "reject more than one calendar annotation if any critical: {$arg}");
}
