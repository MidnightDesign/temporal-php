...
Assert::throws(\InvalidArgumentException::class, fn() => $instance->toZonedDateTime(['plainTime' => $arg, 'timeZone' => 'UTC']), "\"{$arg}\" UTC offset without time is not valid for PlainTime");
}
