...
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$arg) { return $instance->toZonedDateTime((object) ['plainTime' => $arg, 'timeZone' => 'UTC']); }, "annotation keys must be lowercase: {$arg} - {$descr}");
}
