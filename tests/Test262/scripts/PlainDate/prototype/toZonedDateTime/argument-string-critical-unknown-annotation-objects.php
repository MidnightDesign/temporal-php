...
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$arg) { return $instance->toZonedDateTime((object) ['plainTime' => $arg, 'timeZone' => 'UTC']); }, "reject unknown annotation with critical flag: {$arg}");
}
