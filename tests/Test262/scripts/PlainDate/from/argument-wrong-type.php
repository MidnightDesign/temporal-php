...
Assert::throws((is_string($arg) ? \InvalidArgumentException::class : \TypeError::class), fn() => \Temporal\PlainDate::from($arg, $options), "{$description} does not convert to a valid ISO string with options " . json_encode($options) . "");
}
}
