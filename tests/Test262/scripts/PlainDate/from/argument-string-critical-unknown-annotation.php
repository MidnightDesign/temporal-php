...
Assert::throws(\InvalidArgumentException::class, function () use (&$arg) { return \Temporal\Spec\PlainDate::from($arg); }, "reject unknown annotation with critical flag: {$arg}");
}
