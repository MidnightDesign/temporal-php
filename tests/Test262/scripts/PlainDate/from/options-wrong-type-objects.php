...
Assert::throws(\TypeError::class, function () use (&$value) { return \Temporal\Spec\PlainDate::from((object) ['year' => 1976, 'month' => 11, 'day' => 18], $value); }, "TypeError on wrong options type " . (gettype($value)) . "");
