...
Assert::throws(\RangeException::class, function () use (&$badFields) { return \Temporal\Spec\PlainDate::from($badFields, ['overflow' => 'reject']); }, 'bad fields with reject');
...
Assert::throws(\RangeException::class, fn() => \Temporal\Spec\PlainDate::from(['year' => 1976, 'month' => 11, 'monthCode' => 'M12', 'day' => 18]), 'month and monthCode must agree');
