...
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\PlainDate::from(array_merge($base, [$prop => $inf]), ['overflow' => $overflow]), "{$prop} property cannot be {$inf} (overflow {$overflow}");
$calls = [];
