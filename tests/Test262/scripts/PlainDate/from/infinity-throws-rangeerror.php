...
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Spec\PlainDate::from(array_merge($base, [$prop => $inf]), ['overflow' => $overflow]), "{$prop} property cannot be {$inf} (overflow {$overflow}");
$calls = [];
