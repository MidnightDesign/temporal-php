...
$dateFromYearMonth = \Temporal\Spec\PlainDate::from((object) ['year' => $date->year, 'month' => $date->month, 'day' => $date->day]);
...
$dateFromYearMonthCode = \Temporal\Spec\PlainDate::from((object) ['year' => $date->year, 'monthCode' => $date->monthCode, 'day' => $date->day]);
