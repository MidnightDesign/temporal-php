...
Assert::sameValue(\Temporal\Spec\PlainDate::compare(['year' => 1976, 'month' => 11, 'day' => 18], $d2), -1, 'first argument');
Assert::sameValue(\Temporal\Spec\PlainDate::compare(['year' => 2019, 'month' => 6, 'day' => 30], $d2), 0, 'first argument');
Assert::sameValue(\Temporal\Spec\PlainDate::compare(['year' => 2024, 'month' => 1, 'day' => 12], $d2), 1, 'first argument');
