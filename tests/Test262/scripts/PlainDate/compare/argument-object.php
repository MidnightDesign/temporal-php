...
Assert::throws(\TypeError::class, fn() => \Temporal\PlainDate::compare(['year' => 1976], $d2), 'only year in first argument');
Assert::throws(\TypeError::class, fn() => \Temporal\PlainDate::compare($d1, ['year' => 2019]), 'only year in second argument');
