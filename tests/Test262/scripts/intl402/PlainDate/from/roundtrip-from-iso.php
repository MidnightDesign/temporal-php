...
$dateFromYearMonth = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['calendar' => $calendar, 'year' => $date->year, 'month' => $date->month, 'day' => $date->day]));
...
$dateFromYearMonthCode = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['calendar' => $calendar, 'year' => $date->year, 'monthCode' => $date->monthCode, 'day' => $date->day]));
...
$dateFromEraMonth = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['calendar' => $calendar, 'era' => $date->era, 'eraYear' => $date->eraYear, 'month' => $date->month, 'day' => $date->day]));
...
$dateFromEraMonthCode = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['calendar' => $calendar, 'era' => $date->era, 'eraYear' => $date->eraYear, 'monthCode' => $date->monthCode, 'day' => $date->day]));
