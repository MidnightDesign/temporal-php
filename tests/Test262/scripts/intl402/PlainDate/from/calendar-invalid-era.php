...
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Spec\PlainDate::from(['year' => 2025, 'month' => 1, 'day' => 1, 'era' => 'xyz', 'eraYear' => 2025, 'calendar' => $calendar]), "xyz is not a valid era in calendar {$calendar}");
}
