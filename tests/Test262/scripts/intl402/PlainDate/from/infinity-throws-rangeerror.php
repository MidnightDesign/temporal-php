...
Assert::throws(\InvalidArgumentException::class, function () use (&$base, &$obj, &$overflow) { return \Temporal\Spec\PlainDate::from(array_merge($base, ['eraYear' => $obj]), ['overflow' => $overflow]); }, '');
