...
$startOfMonth = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['year' => $leapYear, 'month' => $month, 'day' => 1, 'calendar' => $calendar]), $options);
...
$endOfMonth = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['year' => $leapYear, 'month' => $month, 'day' => $day, 'calendar' => $calendar]), $options);
