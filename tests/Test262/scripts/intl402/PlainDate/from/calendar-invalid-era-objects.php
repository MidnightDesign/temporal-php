...
Assert::throws(\InvalidArgumentException::class, function () use (&$calendar) { return \Temporal\Spec\PlainDate::from((object) ['year' => 2025, 'month' => 1, 'day' => 1, 'era' => 'xyz', 'eraYear' => 2025, 'calendar' => $calendar]); }, "xyz is not a valid era in calendar {$calendar}");
}
foreach ($calendarsWithoutEras as $calendar) {
$result = \Temporal\Spec\PlainDate::from((object) ['year' => 2025, 'month' => 1, 'day' => 1, 'era' => 'xyz', 'eraYear' => 2025, 'calendar' => $calendar]);
