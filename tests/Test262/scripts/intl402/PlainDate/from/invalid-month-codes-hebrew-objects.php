...
Assert::throws(\RangeException::class, function () use (&$monthCode, &$calendar) { \Temporal\Spec\PlainDate::from((object) JsUndefined::strip(['year' => 5779, 'monthCode' => $monthCode, 'day' => 1, 'calendar' => $calendar])); }, '');
}
