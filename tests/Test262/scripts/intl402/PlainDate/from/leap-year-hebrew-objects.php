...
$startOfMonth = \Temporal\Spec\PlainDate::from((object) ['year' => $leapYear, 'month' => $month, 'day' => 1, 'calendar' => $calendar], $options);
...
$endOfMonth = \Temporal\Spec\PlainDate::from((object) ['year' => $leapYear, 'month' => $month, 'day' => $day, 'calendar' => $calendar], $options);
