...
$earlyMeiji = \Temporal\Spec\PlainDate::from((object) ['calendar' => 'japanese', 'era' => 'ce', 'eraYear' => 1870, 'month' => 3, 'day' => 1]);
TemporalHelpers::assertPlainDate($earlyMeiji, 1870, 3, 'M03', 1, 'early pre-Meiji date', 'ce', 1870);
$bceDate = \Temporal\Spec\PlainDate::from((object) ['calendar' => 'japanese', 'era' => 'bce', 'eraYear' => 100, 'month' => 1, 'day' => 1]);
