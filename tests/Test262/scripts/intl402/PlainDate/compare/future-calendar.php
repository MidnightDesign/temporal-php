...
Assert::throws(\RangeException::class, function () use (&$calendar, &$okDate) { \Temporal\Spec\PlainDate::compare(JsUndefined::strip(['year' => 1970, 'month' => 1, 'day' => 1, 'calendar' => $calendar]), $okDate); }, "{$calendar} is not yet supported (first argument, property bag)");
...
Assert::throws(\RangeException::class, function () use (&$okDate, &$calendar) { \Temporal\Spec\PlainDate::compare($okDate, JsUndefined::strip(['year' => 1970, 'month' => 1, 'day' => 1, 'calendar' => $calendar])); }, "{$calendar} is not yet supported (second argument, property bag)");
}
