...
$common1Shevat = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['year' => 5783, 'monthCode' => 'M05', 'day' => 1, 'calendar' => $calendar]), $options);
$common1Adar = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['year' => 5783, 'monthCode' => 'M06', 'day' => 1, 'calendar' => $calendar]), $options);
$common1Nisan = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['year' => 5783, 'monthCode' => 'M07', 'day' => 1, 'calendar' => $calendar]), $options);
$leapShevat = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['year' => 5784, 'monthCode' => 'M05', 'day' => 1, 'calendar' => $calendar]), $options);
$leapAdarI = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['year' => 5784, 'monthCode' => 'M05L', 'day' => 1, 'calendar' => $calendar]), $options);
$leapAdarII = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['year' => 5784, 'monthCode' => 'M06', 'day' => 1, 'calendar' => $calendar]), $options);
$common2Shevat = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['year' => 5785, 'monthCode' => 'M05', 'day' => 1, 'calendar' => $calendar]), $options);
