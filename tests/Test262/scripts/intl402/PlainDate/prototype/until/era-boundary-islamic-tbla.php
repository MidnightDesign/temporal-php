...
$bh5 = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['era' => 'bh', 'eraYear' => 5, 'monthCode' => 'M06', 'day' => 15, 'calendar' => $calendar]), $options);
$bh2 = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['era' => 'bh', 'eraYear' => 2, 'monthCode' => 'M12', 'day' => 1, 'calendar' => $calendar]), $options);
$bh1 = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['era' => 'bh', 'eraYear' => 1, 'monthCode' => 'M06', 'day' => 15, 'calendar' => $calendar]), $options);
$ah1 = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['era' => 'ah', 'eraYear' => 1, 'monthCode' => 'M06', 'day' => 15, 'calendar' => $calendar]), $options);
$ah2 = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['era' => 'ah', 'eraYear' => 2, 'monthCode' => 'M01', 'day' => 1, 'calendar' => $calendar]), $options);
$ah5 = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['era' => 'ah', 'eraYear' => 5, 'monthCode' => 'M06', 'day' => 15, 'calendar' => $calendar]), $options);
