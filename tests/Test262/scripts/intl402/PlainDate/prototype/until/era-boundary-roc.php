...
$broc5 = \Temporal\Spec\PlainDate::from(['era' => 'broc', 'eraYear' => 5, 'monthCode' => 'M03', 'day' => 1, 'calendar' => $calendar], $options);
$broc3 = \Temporal\Spec\PlainDate::from(['era' => 'broc', 'eraYear' => 3, 'monthCode' => 'M01', 'day' => 1, 'calendar' => $calendar], $options);
$broc1 = \Temporal\Spec\PlainDate::from(['era' => 'broc', 'eraYear' => 1, 'monthCode' => 'M06', 'day' => 1, 'calendar' => $calendar], $options);
$roc1 = \Temporal\Spec\PlainDate::from(['era' => 'roc', 'eraYear' => 1, 'monthCode' => 'M06', 'day' => 1, 'calendar' => $calendar], $options);
$roc5 = \Temporal\Spec\PlainDate::from(['era' => 'roc', 'eraYear' => 5, 'monthCode' => 'M03', 'day' => 1, 'calendar' => $calendar], $options);
$roc10 = \Temporal\Spec\PlainDate::from(['era' => 'roc', 'eraYear' => 10, 'monthCode' => 'M01', 'day' => 1, 'calendar' => $calendar], $options);
