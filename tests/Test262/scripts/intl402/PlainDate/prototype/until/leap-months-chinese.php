...
$common1Month4 = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['year' => 2000, 'monthCode' => 'M04', 'day' => 1, 'calendar' => $calendar]), $options);
$common1Month5 = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['year' => 2000, 'monthCode' => 'M05', 'day' => 1, 'calendar' => $calendar]), $options);
$common1Month6 = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['year' => 2000, 'monthCode' => 'M06', 'day' => 1, 'calendar' => $calendar]), $options);
$leapMonth4 = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['year' => 2001, 'monthCode' => 'M04', 'day' => 1, 'calendar' => $calendar]), $options);
$leapMonth4L = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['year' => 2001, 'monthCode' => 'M04L', 'day' => 1, 'calendar' => $calendar]), $options);
$leapMonth5 = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['year' => 2001, 'monthCode' => 'M05', 'day' => 1, 'calendar' => $calendar]), $options);
$common2Month4 = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['year' => 2002, 'monthCode' => 'M04', 'day' => 1, 'calendar' => $calendar]), $options);
$common2Month5 = \Temporal\Spec\PlainDate::from(JsUndefined::strip(['year' => 2002, 'monthCode' => 'M05', 'day' => 1, 'calendar' => $calendar]), $options);
