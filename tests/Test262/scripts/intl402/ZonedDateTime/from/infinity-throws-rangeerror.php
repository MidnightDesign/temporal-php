...
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Spec\ZonedDateTime::from(array_merge($base, ['eraYear' => $inf]), ['overflow' => $overflow]), "eraYear property cannot be {$inf} (overflow {$overflow}");
$calls = [];
