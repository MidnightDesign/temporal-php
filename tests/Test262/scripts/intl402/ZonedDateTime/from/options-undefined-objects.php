...
$overflowPropertyImplicit = \Temporal\Spec\ZonedDateTime::from($overflowFields, (object) []);
...
$disambiguationEarlierFields = (object) ['timeZone' => $timeZone, 'year' => 2000, 'month' => 10, 'day' => 29, 'hour' => 1, 'minute' => 34, 'second' => 56, 'millisecond' => 987, 'microsecond' => 654, 'nanosecond' => 321];
$disambiguationLaterFields = (object) ['timeZone' => $timeZone, 'year' => 2000, 'month' => 4, 'day' => 2, 'hour' => 2, 'minute' => 34, 'second' => 56, 'millisecond' => 987, 'microsecond' => 654, 'nanosecond' => 321];
...
$propertyImplicit = \Temporal\Spec\ZonedDateTime::from($fields, (object) []);
...
Assert::throws(\InvalidArgumentException::class, function () use (&$offsetFields) { return \Temporal\Spec\ZonedDateTime::from($offsetFields, (object) []); }, 'default offset is reject');
Assert::throws(\InvalidArgumentException::class, function () use (&$offsetFields) { return \Temporal\Spec\ZonedDateTime::from($offsetFields); }, 'default offset is reject');
