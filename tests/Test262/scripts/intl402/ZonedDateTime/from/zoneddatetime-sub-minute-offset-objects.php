...
Assert::throws(\RangeException::class, fn() => \Temporal\Spec\ZonedDateTime::from('1970-01-01T00:00-00:44:30[-00:45]', (object) ['offset' => 'reject']), 'minute rounding not supported for offset time zones');
...
Assert::throws(\RangeException::class, function () use (&$wrongSeconds) { return \Temporal\Spec\ZonedDateTime::from($wrongSeconds, (object) ['offset' => 'reject']); }, 'wrong :SS not accepted in string offset (offset=reject)');
Assert::throws(\RangeException::class, function () use (&$roundedSeconds) { return \Temporal\Spec\ZonedDateTime::from($roundedSeconds, (object) ['offset' => 'reject']); }, 'rounded HH:MM:SS not accepted in string offset (offset=reject)');
...
Assert::throws(\RangeException::class, function () use (&$properties) { return \Temporal\Spec\ZonedDateTime::from($properties, (object) ['offset' => 'reject']); }, 'no fuzzy matching is done on offset in property bag (offset=reject)');
