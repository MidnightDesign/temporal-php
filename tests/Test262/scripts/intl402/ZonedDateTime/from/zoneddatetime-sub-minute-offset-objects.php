...
$result = \Temporal\Spec\ZonedDateTime::from('1970-01-01T12:00-00:44:30[Africa/Monrovia]', (object) ['offset' => $offset]);
...
foreach (['use', 'ignore', 'prefer', 'reject'] as $offset) {
$result = \Temporal\Spec\ZonedDateTime::from('1970-01-01T12:00-00:44:30.000000000[Africa/Monrovia]', (object) ['offset' => $offset]);
...
$result = \Temporal\Spec\ZonedDateTime::from($str, (object) ['offset' => $offset]);
...
$resultWrongSeconds = \Temporal\Spec\ZonedDateTime::from($wrongSeconds, (object) ['offset' => $offset]);
...
$resultRoundedSeconds = \Temporal\Spec\ZonedDateTime::from($roundedSeconds, (object) ['offset' => $offset]);
...
foreach (['ignore', 'prefer'] as $offset) {
$result = \Temporal\Spec\ZonedDateTime::from($properties, (object) ['offset' => $offset]);
