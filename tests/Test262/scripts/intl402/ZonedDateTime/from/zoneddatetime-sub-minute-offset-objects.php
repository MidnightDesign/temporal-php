...
$result = \Temporal\Spec\ZonedDateTime::from('1970-01-01T12:00-00:44:30[Africa/Monrovia]', (object) JsUndefined::strip(['offset' => $offset]));
...
foreach (['use', 'ignore', 'prefer', 'reject'] as $offset) {
$result = \Temporal\Spec\ZonedDateTime::from('1970-01-01T12:00-00:44:30.000000000[Africa/Monrovia]', (object) JsUndefined::strip(['offset' => $offset]));
...
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Spec\ZonedDateTime::from('1970-01-01T00:00-00:44:30[-00:45]', (object) ['offset' => 'reject']), 'minute rounding not supported for offset time zones');
$str = '1970-01-01T12:00-00:45[Africa/Monrovia]';
foreach (['ignore', 'prefer', 'reject'] as $offset) {
$result = \Temporal\Spec\ZonedDateTime::from($str, (object) JsUndefined::strip(['offset' => $offset]));
...
$result = \Temporal\Spec\ZonedDateTime::from($str, (object) ['offset' => 'use']);
...
$useResultWrongSeconds = \Temporal\Spec\ZonedDateTime::from($wrongSeconds, (object) ['offset' => 'use']);
...
$useResultRoundedSeconds = \Temporal\Spec\ZonedDateTime::from($roundedSeconds, (object) ['offset' => 'use']);
...
$resultWrongSeconds = \Temporal\Spec\ZonedDateTime::from($wrongSeconds, (object) JsUndefined::strip(['offset' => $offset]));
...
$resultRoundedSeconds = \Temporal\Spec\ZonedDateTime::from($roundedSeconds, (object) JsUndefined::strip(['offset' => $offset]));
...
Assert::throws(\InvalidArgumentException::class, function () use (&$wrongSeconds) { return \Temporal\Spec\ZonedDateTime::from($wrongSeconds, (object) ['offset' => 'reject']); }, 'wrong :SS not accepted in string offset (offset=reject)');
Assert::throws(\InvalidArgumentException::class, function () use (&$roundedSeconds) { return \Temporal\Spec\ZonedDateTime::from($roundedSeconds, (object) ['offset' => 'reject']); }, 'rounded HH:MM:SS not accepted in string offset (offset=reject)');
$properties = (object) ['year' => 1970, 'month' => 1, 'day' => 1, 'hour' => 12, 'offset' => '-00:45', 'timeZone' => 'Africa/Monrovia'];
foreach (['ignore', 'prefer'] as $offset) {
$result = \Temporal\Spec\ZonedDateTime::from($properties, (object) JsUndefined::strip(['offset' => $offset]));
...
$result2 = \Temporal\Spec\ZonedDateTime::from($properties, (object) ['offset' => 'use']);
...
Assert::throws(\InvalidArgumentException::class, function () use (&$properties) { return \Temporal\Spec\ZonedDateTime::from($properties, (object) ['offset' => 'reject']); }, 'no fuzzy matching is done on offset in property bag (offset=reject)');
