...
Assert::throws(\InvalidArgumentException::class, function () use (&$base, &$obj1, &$other) { return \Temporal\Spec\ZonedDateTime::compare(array_merge($base, ['eraYear' => $obj1]), $other); }, '');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$other, &$base, &$obj2) { return \Temporal\Spec\ZonedDateTime::compare($other, array_merge($base, ['eraYear' => $obj2])); }, '');
