...
$date74921201 = \Temporal\Spec\ZonedDateTime::from(JsUndefined::strip(['year' => 7492, 'monthCode' => 'M12', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
$dates = [$date74921201];
