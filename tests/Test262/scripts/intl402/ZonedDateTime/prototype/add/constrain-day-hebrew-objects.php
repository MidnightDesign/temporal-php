...
Assert::throws(\InvalidArgumentException::class, function () use (&$rcM03, &$years3, &$options) { $rcM03->add($years3, $options); }, 'regular-year Kislev rejects 30 in deficient year when adding');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$clM02, &$years3, &$options) { $clM02->add($years3, $options); }, 'complete-year Cheshvan rejects 30 in regular year when adding');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$clM02, &$years2, &$options) { $clM02->add($years2, $options); }, 'complete-year Cheshvan rejects 30 in deficient year when adding');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$clM03, &$years2, &$options) { $clM03->add($years2, $options); }, 'complete-year Kislev rejects 30 in deficient year when adding');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rlM03, &$years1n, &$options) { $rlM03->add($years1n, $options); }, 'regular-year Kislev rejects 30 in deficient year when subtracting');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$ccM02, &$years1n, &$options) { $ccM02->add($years1n, $options); }, 'complete-year Cheshvan rejects 30 in regular year when subtracting');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$ccM02, &$years2n, &$options) { $ccM02->add($years2n, $options); }, 'complete-year Cheshvan rejects 30 in deficient year when subtracting');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$ccM03, &$years2n, &$options) { $ccM03->add($years2n, $options); }, 'complete-year Kislev rejects 30 in deficient year when subtracting');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rc0130, &$months1, &$options) { $rc0130->add($months1, $options); }, 'regular common year Cheshvan rejects 30 when adding');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$dc0130, &$months2, &$options) { $dc0130->add($months2, $options); }, 'deficient common year Kislev rejects 30 when adding');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rc0130, &$months3, &$options) { $rc0130->add($months3, $options); }, 'common-year Tevet rejects 30 when adding');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rc0130, &$months5, &$options) { $rc0130->add($months5, $options); }, 'common-year Adar rejects 30 when adding');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rc0130, &$months7, &$options) { $rc0130->add($months7, $options); }, 'common-year Iyar rejects 30 when adding');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rc0130, &$months9, &$options) { $rc0130->add($months9, $options); }, 'common-year Tammuz rejects 30 when adding');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rc0130, &$months11, &$options) { $rc0130->add($months11, $options); }, 'common-year Elul rejects 30 when adding');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rl0130, &$months1, &$options) { $rl0130->add($months1, $options); }, 'regular leap year Cheshvan rejects 30 when adding');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$dl0130, &$months2, &$options) { $dl0130->add($months2, $options); }, 'deficient leap year Kislev rejects 30 when adding');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rl0130, &$months3, &$options) { $rl0130->add($months3, $options); }, 'leap-year Tevet rejects 30 when adding');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rl0130, &$months6, &$options) { $rl0130->add($months6, $options); }, 'leap-year Adar II rejects 30 when adding');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rl0130, &$months8, &$options) { $rl0130->add($months8, $options); }, 'leap-year Iyar rejects 30 when adding');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rl0130, &$months10, &$options) { $rl0130->add($months10, $options); }, 'leap-year Tammuz rejects 30 when adding');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rl0130, &$months12, &$options) { $rl0130->add($months12, $options); }, 'leap-year Elul rejects 30 when adding');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rc0130After, &$months11n, &$options) { $rc0130After->add($months11n, $options); }, 'regular common year Cheshvan rejects 30 when subtracting');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$dc0130After, &$months10n, &$options) { $dc0130After->add($months10n, $options); }, 'deficient common year Kislev rejects 30 when subtracting');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rc0130After, &$months9n, &$options) { $rc0130After->add($months9n, $options); }, 'common-year Tevet rejects 30 when subtracting');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rc0130After, &$months7n, &$options) { $rc0130After->add($months7n, $options); }, 'common-year Adar rejects 30 when subtracting');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rc0130After, &$months5n, &$options) { $rc0130After->add($months5n, $options); }, 'common-year Iyar rejects 30 when subtracting');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rc0130After, &$months3n, &$options) { $rc0130After->add($months3n, $options); }, 'common-year Tammuz rejects 30 when subtracting');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rc0130After, &$months1n, &$options) { $rc0130After->add($months1n, $options); }, 'common-year Elul rejects 30 when subtracting');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rl0130After, &$months12n, &$options) { $rl0130After->add($months12n, $options); }, 'regular leap year Cheshvan rejects 30 when subtracting');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$dl0130After, &$months11n, &$options) { $dl0130After->add($months11n, $options); }, 'deficient leap year Kislev rejects 30 when subtracting');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rl0130After, &$months10n, &$options) { $rl0130After->add($months10n, $options); }, 'leap-year Tevet rejects 30 when subtracting');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rl0130After, &$months7n, &$options) { $rl0130After->add($months7n, $options); }, 'leap-year Adar II rejects 30 when subtracting');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rl0130After, &$months5n, &$options) { $rl0130After->add($months5n, $options); }, 'leap-year Iyar rejects 30 when subtracting');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rl0130After, &$months3n, &$options) { $rl0130After->add($months3n, $options); }, 'leap-year Tammuz rejects 30 when subtracting');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$rl0130After, &$months1n, &$options) { $rl0130After->add($months1n, $options); }, 'leap-year Elul rejects 30 when subtracting');
