...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13630131, &$months6, &$options) { $date13630131->add($months6, $options); }, 'common-year Mehr rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13630131, &$months7, &$options) { $date13630131->add($months7, $options); }, 'common-year Aban rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13620131, &$months8, &$options) { $date13620131->add($months8, $options); }, 'common-year Azar rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13630131, &$months9, &$options) { $date13630131->add($months9, $options); }, 'common-year Dey rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13630131, &$months10, &$options) { $date13630131->add($months10, $options); }, 'common-year Bahman rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13630131, &$months11, &$options) { $date13630131->add($months11, $options); }, 'common-year Esfand rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13620131, &$months6, &$options) { $date13620131->add($months6, $options); }, 'leap-year Mehr rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13620131, &$months7, &$options) { $date13620131->add($months7, $options); }, 'leap-year Aban rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13620131, &$months8, &$options) { $date13620131->add($months8, $options); }, 'leap-year Azar rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13620131, &$months9, &$options) { $date13620131->add($months9, $options); }, 'leap-year Dey rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13620131, &$months10, &$options) { $date13620131->add($months10, $options); }, 'leap-year Bahman rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13630131, &$months11, &$options) { $date13630131->add($months11, $options); }, 'leap-year Esfand rejects with 30');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13640131, &$months6n, &$options) { $date13640131->add($months6n, $options); }, 'common-year Mehr rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13640131, &$months5n, &$options) { $date13640131->add($months5n, $options); }, 'common-year Aban rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13640131, &$months4n, &$options) { $date13640131->add($months4n, $options); }, 'common-year Azar rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13640131, &$months3n, &$options) { $date13640131->add($months3n, $options); }, 'common-year Dey rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13640131, &$months2n, &$options) { $date13640131->add($months2n, $options); }, 'common-year Bahman rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13640131, &$months1n, &$options) { $date13640131->add($months1n, $options); }, 'common-year Esfand rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13630131, &$months6n, &$options) { $date13630131->add($months6n, $options); }, 'leap-year Mehr rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13630131, &$months5n, &$options) { $date13630131->add($months5n, $options); }, 'leap-year Aban rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13630131, &$months4n, &$options) { $date13630131->add($months4n, $options); }, 'leap-year Azar rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13630131, &$months3n, &$options) { $date13630131->add($months3n, $options); }, 'leap-year Dey rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13630131, &$months2n, &$options) { $date13630131->add($months2n, $options); }, 'leap-year Bahman rejects with 31');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$date13630131, &$months1n, &$options) { $date13630131->add($months1n, $options); }, 'leap-year Esfand rejects with 31');
