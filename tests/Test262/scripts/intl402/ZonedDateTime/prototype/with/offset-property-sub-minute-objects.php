...
$instance = \Temporal\Spec\ZonedDateTime::from((object) ['year' => 1970, 'month' => 1, 'day' => 1, 'hour' => 12, 'timeZone' => 'Africa/Monrovia']);
...
$result = $instance->with($properties, (object) ['offset' => $offset]);
...
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$properties) { return $instance->with($properties, (object) ['offset' => 'reject']); }, 'no fuzzy matching is done in with()');
