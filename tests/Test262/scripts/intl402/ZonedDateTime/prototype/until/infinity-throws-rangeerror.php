...
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$base, &$inf) { return $instance->until(array_merge($base, ['eraYear' => $inf])); }, "eraYear property cannot be {$inf}");
$calls = [];
$obj = TemporalHelpers::toPrimitiveObserver($calls, $inf, 'eraYear');
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$base, &$obj) { return $instance->until(array_merge($base, ['eraYear' => $obj])); }, '');
