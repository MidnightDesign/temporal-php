...
$common1Shevat = \Temporal\Spec\ZonedDateTime::from(JsUndefined::strip(['year' => 5783, 'monthCode' => 'M05', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
...
$common1Nisan = \Temporal\Spec\ZonedDateTime::from(JsUndefined::strip(['year' => 5783, 'monthCode' => 'M07', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
$leapShevat = \Temporal\Spec\ZonedDateTime::from(JsUndefined::strip(['year' => 5784, 'monthCode' => 'M05', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
$leapAdarI = \Temporal\Spec\ZonedDateTime::from(JsUndefined::strip(['year' => 5784, 'monthCode' => 'M05L', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
$leapAdarII = \Temporal\Spec\ZonedDateTime::from(JsUndefined::strip(['year' => 5784, 'monthCode' => 'M06', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
$common2Shevat = \Temporal\Spec\ZonedDateTime::from(JsUndefined::strip(['year' => 5785, 'monthCode' => 'M05', 'day' => 1, 'hour' => 12, 'minute' => 34, 'timeZone' => 'UTC', 'calendar' => $calendar]), $options);
