...
$properties = (object) ['offset' => '-00:45', 'year' => 1970, 'month' => 1, 'day' => 1, 'minute' => 44, 'second' => 30, 'timeZone' => $timeZone];
...
Assert::throws(\InvalidArgumentException::class, function () use (&$reference) { return $reference->since('1952-10-15T23:59:59-11:19:50[Pacific/Niue]'); }, 'wrong :SS not accepted in the Pacific/Niue edge case');
