...
$roundMeUp = \Temporal\Spec\PlainDateTime::from('2000-10-29T11:30:01')->toZonedDateTime('America/Vancouver');
Assert::sameValue("{$roundMeUp->round($roundTo)}", '2000-10-30T00:00:00-08:00[America/Vancouver]', '');
$roundTo = ['smallestUnit' => 'day'];
$roundMeDown = \Temporal\Spec\PlainDateTime::from('2000-04-02T12:29:59')->toZonedDateTime('America/Vancouver');
Assert::sameValue("{$roundMeDown->round($roundTo)}", '2000-04-02T00:00:00-08:00[America/Vancouver]', '');
$roundMeUp = \Temporal\Spec\PlainDateTime::from('2000-04-02T12:30:01')->toZonedDateTime('America/Vancouver');
Assert::sameValue("{$roundMeUp->round($roundTo)}", '2000-04-03T00:00:00-07:00[America/Vancouver]', '');
$almostSkipped = \Temporal\Spec\PlainDateTime::from('2000-04-02T01:59:59.999999999')->toZonedDateTime('America/Vancouver');
