...
$result1 = \Temporal\Spec\PlainYearMonth::from((object) ['calendar' => 'japanese', 'era' => 'heisei', 'eraYear' => 1, 'month' => 1]);
...
$result2 = \Temporal\Spec\PlainYearMonth::from((object) ['calendar' => 'japanese', 'era' => 'showa', 'eraYear' => 1, 'month' => 12]);
...
$result3 = \Temporal\Spec\PlainYearMonth::from((object) ['calendar' => 'japanese', 'era' => 'taisho', 'eraYear' => 1, 'month' => 7]);
