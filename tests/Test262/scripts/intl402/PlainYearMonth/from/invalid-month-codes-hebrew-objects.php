...
$calendar = 'hebrew';
Assert::throws(\RangeException::class, function () use (&$calendar) { \Temporal\Spec\PlainYearMonth::from((object) JsUndefined::strip(['year' => 5779, 'monthCode' => 'M13', 'calendar' => $calendar])); }, 'M13 should not be a valid month code');
