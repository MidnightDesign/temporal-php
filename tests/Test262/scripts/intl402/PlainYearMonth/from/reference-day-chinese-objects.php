...
Assert::throws(\RangeException::class, function () use (&$fields) { return \Temporal\Spec\PlainYearMonth::from($fields, (object) ['overflow' => 'reject']); }, "Chinese intercalary month {$leapMonthCode} does not exist in year 2022 (overflow reject)");
}
