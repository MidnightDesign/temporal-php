...
$common1Shevat = \Temporal\Spec\PlainYearMonth::from((object) ['year' => 5783, 'monthCode' => 'M05', 'calendar' => $calendar], $options);
$common1Adar = \Temporal\Spec\PlainYearMonth::from((object) ['year' => 5783, 'monthCode' => 'M06', 'calendar' => $calendar], $options);
$common1Nisan = \Temporal\Spec\PlainYearMonth::from((object) ['year' => 5783, 'monthCode' => 'M07', 'calendar' => $calendar], $options);
$leapShevat = \Temporal\Spec\PlainYearMonth::from((object) ['year' => 5784, 'monthCode' => 'M05', 'calendar' => $calendar], $options);
$leapAdarI = \Temporal\Spec\PlainYearMonth::from((object) ['year' => 5784, 'monthCode' => 'M05L', 'calendar' => $calendar], $options);
$leapAdarII = \Temporal\Spec\PlainYearMonth::from((object) ['year' => 5784, 'monthCode' => 'M06', 'calendar' => $calendar], $options);
$common2Shevat = \Temporal\Spec\PlainYearMonth::from((object) ['year' => 5785, 'monthCode' => 'M05', 'calendar' => $calendar], $options);
