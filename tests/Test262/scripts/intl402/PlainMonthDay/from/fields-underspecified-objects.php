...
Assert::throws(\TypeError::class, function () use (&$arg, &$calendarId) { return \Temporal\Spec\PlainMonthDay::from((object) JsUndefined::strip(array_merge((is_object($arg) ? (array) $arg : $arg), ['calendar' => $calendarId]))); }, $description);
}
