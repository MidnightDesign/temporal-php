...
Assert::throws(\RangeException::class, function () use (&$calendar) { \Temporal\Spec\PlainMonthDay::from((object) JsUndefined::strip(['calendar' => $calendar, 'monthCode' => 'M13', 'day' => 7]), (object) ['overflow' => 'reject']); }, 'M13 with day 7 should throw with reject overflow');
