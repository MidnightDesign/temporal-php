...
$pmd = \Temporal\Spec\PlainMonthDay::from((object) ['calendar' => $calendar, 'monthCode' => $monthCode, 'day' => 30]);
TemporalHelpers::assertPlainMonthDay($pmd, $monthCode, 30, "{$monthCode}-30", $referenceYear);
$constrain = \Temporal\Spec\PlainMonthDay::from((object) ['calendar' => $calendar, 'monthCode' => $monthCode, 'day' => 31]);
...
Assert::throws(\InvalidArgumentException::class, function () use (&$calendar, &$monthCode) { \Temporal\Spec\PlainMonthDay::from((object) ['calendar' => $calendar, 'monthCode' => $monthCode, 'day' => 31], (object) ['overflow' => 'reject']); }, '');
}
