...
Assert::throws(\InvalidArgumentException::class, function () use (&$calendar) { \Temporal\Spec\PlainMonthDay::from(JsUndefined::strip(['calendar' => $calendar, 'monthCode' => 'M13', 'day' => 7]), ['overflow' => 'reject']); }, 'M13 with day 7 should throw with reject overflow');
