...
$monthsInYear = \Temporal\Spec\PlainDateTime::from(JsUndefined::strip(['year' => $year, 'month' => 1, 'calendar' => $calendar, 'day' => 1, 'hour' => 12, 'minute' => 34]))->monthsInYear;
for ($month = 1; $month < $monthsInYear; $month++) {
$date = \Temporal\Spec\PlainDateTime::from(JsUndefined::strip(['year' => $year, 'month' => $month, 'calendar' => $calendar, 'day' => 1, 'hour' => 12, 'minute' => 34]));
if ($date->inLeapYear) {
