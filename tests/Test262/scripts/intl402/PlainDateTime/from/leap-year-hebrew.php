...
$startOfMonth = \Temporal\Spec\PlainDateTime::from(JsUndefined::strip(['year' => $leapYear, 'month' => $month, 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
...
$endOfMonth = \Temporal\Spec\PlainDateTime::from(JsUndefined::strip(['year' => $leapYear, 'month' => $month, 'day' => $day, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
