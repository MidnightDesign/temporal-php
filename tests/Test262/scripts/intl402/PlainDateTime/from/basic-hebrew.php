...
$startOfMonth = \Temporal\Spec\PlainDateTime::from(JsUndefined::strip(['year' => $commonYear, 'month' => $month, 'day' => 1, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
...
$endOfMonth = \Temporal\Spec\PlainDateTime::from(JsUndefined::strip(['year' => $commonYear, 'month' => $month, 'day' => $day, 'hour' => 12, 'minute' => 34, 'calendar' => $calendar]), $options);
