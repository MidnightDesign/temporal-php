...
Assert::throws(\InvalidArgumentException::class, fn() => $instance->round(['smallestUnit' => 'seconds', 'relativeTo' => array_merge($base, ['eraYear' => $inf])]), "eraYear property cannot be {$inf} in relativeTo");
$calls = [];
