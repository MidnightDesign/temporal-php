...
Assert::sameValue(1, \Temporal\Spec\Duration::compare($d1, (object) ['years' => 1, 'hours' => 24], (object) JsUndefined::strip(['relativeTo' => $relativeTo])), '2020-10-29 has more than 24 hours');
