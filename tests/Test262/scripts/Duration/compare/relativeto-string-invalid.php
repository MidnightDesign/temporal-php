...
Assert::throws(\RangeException::class, function () use (&$duration, &$relativeTo) { return \Temporal\Spec\Duration::compare($duration, $duration, JsUndefined::strip(['relativeTo' => $relativeTo])); }, '');
}
