...
$resultWithout = \Temporal\Spec\Duration::compare($duration1, $duration2, JsUndefined::strip(['relativeTo' => $relativeTo]));
...
$resultWith = \Temporal\Spec\Duration::compare($duration1, $duration2, JsUndefined::strip(['relativeTo' => $relativeTo]));
