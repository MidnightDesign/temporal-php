...
Assert::throws(\RangeException::class, function () use (&$instance, &$blankInstance, &$relativeTo) { return \Temporal\Spec\Duration::compare($instance, $blankInstance, (object) JsUndefined::strip(['relativeTo' => $relativeTo])); }, "\"{$relativeTo}\" is outside the representable range for a relativeTo parameter");
}
