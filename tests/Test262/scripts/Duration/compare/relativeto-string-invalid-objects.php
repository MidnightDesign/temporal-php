...
Assert::throws(\InvalidArgumentException::class, function () use (&$duration, &$relativeTo) { return \Temporal\Spec\Duration::compare($duration, $duration, (object) JsUndefined::strip(['relativeTo' => $relativeTo])); }, '');
}
