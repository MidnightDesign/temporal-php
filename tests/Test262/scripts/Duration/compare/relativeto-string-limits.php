...
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$blankInstance, &$relativeTo) { return \Temporal\Spec\Duration::compare($instance, $blankInstance, ['relativeTo' => $relativeTo]); }, "\"{$relativeTo}\" is outside the representable range for a relativeTo parameter");
}
