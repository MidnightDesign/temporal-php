...
Assert::sameValue(-1, \Temporal\Spec\Duration::compare($duration1a, $duration1b, (object) ['relativeTo' => $relativeTo]), 'compare succeeds for year-only Duration provided relativeTo is supplied');
...
Assert::sameValue(-1, \Temporal\Spec\Duration::compare($duration2a, $duration2b, (object) ['relativeTo' => $relativeTo]), 'compare succeeds for year-and-month Duration provided relativeTo is supplied');
...
Assert::sameValue(-1, \Temporal\Spec\Duration::compare($duration3a, $duration3b, (object) ['relativeTo' => $relativeTo]), 'compare succeeds for year-and-month-and-week Duration provided relativeTo is supplied');
...
Assert::sameValue(-1, \Temporal\Spec\Duration::compare($duration4a, $duration4b, (object) ['relativeTo' => $relativeTo]), 'compare succeeds for zero year-month-week non-zero day Duration with relativeTo');
