...
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$unit) { return $instance->total((object) ['unit' => $unit]); }, "{ unit: \"{$unit}\" } should not be allowed as an argument to total");
