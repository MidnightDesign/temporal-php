...
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$unit) { return $instance->total((object) JsUndefined::strip(['unit' => $unit])); }, "{ unit: \"{$unit}\" } should not be allowed as an argument to total");
