...
Assert::throws(\InvalidArgumentException::class, fn() => $instance->total(['unit' => 'seconds', 'relativeTo' => array_merge($base, [$prop => $inf])]), "{$prop} property cannot be {$inf} in relativeTo");
$calls = [];
