...
Assert::throws(\InvalidArgumentException::class, function () use (&$duration, &$unit) { return $duration->total(JsUndefined::strip(['unit' => $unit])); }, "{$duration} total {$unit} requires relativeTo");
