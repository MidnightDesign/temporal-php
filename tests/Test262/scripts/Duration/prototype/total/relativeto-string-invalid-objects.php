...
Assert::throws(\InvalidArgumentException::class, function () use (&$duration, &$relativeTo) { return $duration->total((object) ['unit' => 'months', 'relativeTo' => $relativeTo]); }, $description);
}
