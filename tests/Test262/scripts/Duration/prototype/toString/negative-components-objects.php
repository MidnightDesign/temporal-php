...
Assert::sameValue(\Temporal\Spec\Duration::from((object) ['milliseconds' => -250])->toString(), '-PT0.25S', '');
Assert::sameValue(\Temporal\Spec\Duration::from((object) ['milliseconds' => -3500])->toString(), '-PT3.5S', '');
Assert::sameValue(\Temporal\Spec\Duration::from((object) ['microseconds' => -250])->toString(), '-PT0.00025S', '');
Assert::sameValue(\Temporal\Spec\Duration::from((object) ['microseconds' => -3500])->toString(), '-PT0.0035S', '');
Assert::sameValue(\Temporal\Spec\Duration::from((object) ['nanoseconds' => -250])->toString(), '-PT0.00000025S', '');
...
Assert::sameValue(\Temporal\Spec\Duration::from((object) ['weeks' => -1, 'days' => -1])->toString(), '-P1W1D', '');
