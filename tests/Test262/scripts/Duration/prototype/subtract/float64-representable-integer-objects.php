...
$result = $d->subtract((object) JsUndefined::strip(['microseconds' => -9_007_199_254_740_991 + 1]));
...
Assert::sameValue(\Temporal\Spec\Duration::compare($result->subtract((object) ['microseconds' => 1]), $result), 0, 'subsequent subtract() should not use more precise internal representation than the spec prescribes');
