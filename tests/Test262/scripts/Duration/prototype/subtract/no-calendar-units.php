...
Assert::throws(\InvalidArgumentException::class, fn() => $ok->subtract(['years' => 1]), 'should not subtract property bag with years');
Assert::throws(\InvalidArgumentException::class, fn() => $ok->subtract(['months' => 1]), 'should not subtract property bag with months');
Assert::throws(\InvalidArgumentException::class, fn() => $ok->subtract(['weeks' => 1]), 'should not subtract property bag with weeks');
Assert::throws(\InvalidArgumentException::class, fn() => $ok->subtract('P1Y'), 'should not subtract string with years');
Assert::throws(\InvalidArgumentException::class, fn() => $ok->subtract('P1M'), 'should not subtract string with months');
