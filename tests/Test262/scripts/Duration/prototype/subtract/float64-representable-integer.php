...
Assert::sameValue(\Temporal\Duration::compare($result->subtract(['microseconds' => 1]), $result), 0, 'subsequent subtract() should not use more precise internal representation than the spec prescribes');
