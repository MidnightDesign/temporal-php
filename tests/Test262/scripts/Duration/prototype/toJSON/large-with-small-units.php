...
Assert::sameValue(new \Temporal\Spec\Duration(0, 0, 0, 1, 0, 0, 1)->toJSON(), 'P1DT1S', 'days with seconds');
Assert::sameValue(new \Temporal\Spec\Duration(0, 0, 0, 0, 1, 1)->toJSON(), 'PT1H1M', 'hours with minutes');
