...
$result = $duration->round((object) ['smallestUnit' => 'months', 'roundingMode' => $roundingMode, 'relativeTo' => $relativeTo]);
...
$result = $duration->round((object) ['smallestUnit' => 'seconds', 'roundingMode' => $roundingMode]);
