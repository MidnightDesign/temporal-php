...
Assert::throws(\InvalidArgumentException::class, function () use (&$duration, &$largestUnit) { return $duration->round((object) ['largestUnit' => $largestUnit]); }, "balancing {$duration} to {$largestUnit} requires relativeTo");
}
}
