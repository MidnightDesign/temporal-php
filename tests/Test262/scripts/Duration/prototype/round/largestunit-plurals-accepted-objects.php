...
TemporalHelpers::checkPluralUnitsAccepted(function ($largestUnit) use (&$duration, &$relativeTo) { return $duration->round((object) ['largestUnit' => $largestUnit, 'relativeTo' => $relativeTo]); }, $validUnits);
