...
$blankInstance->round(['smallestUnit' => 'minutes', 'relativeTo' => $relativeTo]);
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$relativeTo) { return $instance->round(['smallestUnit' => 'minutes', 'relativeTo' => $relativeTo]); }, "\"{$relativeTo}\" is outside the representable range for a relativeTo parameter after conversion to DateTime");
}
...
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$relativeTo) { return $instance->round(['smallestUnit' => 'minutes', 'relativeTo' => $relativeTo]); }, "\"{$relativeTo}\" is outside the representable range for a relativeTo parameter");
Assert::throws(\InvalidArgumentException::class, function () use (&$blankInstance, &$relativeTo) { return $blankInstance->round(['smallestUnit' => 'minutes', 'relativeTo' => $relativeTo]); }, "\"{$relativeTo}\" is outside the representable range for a relativeTo parameter");
}
