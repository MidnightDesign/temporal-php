...
$relativeToYears = (object) ['relativeTo' => $pd, 'largestUnit' => 'years'];
$relativeToMonths = (object) ['relativeTo' => $pd, 'largestUnit' => 'months'];
$relativeToWeeks = (object) ['relativeTo' => $pd, 'largestUnit' => 'weeks'];
$relativeToDays = (object) ['relativeTo' => $pd, 'largestUnit' => 'days'];
Assert::throws(\InvalidArgumentException::class, function () use (&$duration1, &$pd) { $duration1->round((object) ['relativeTo' => $pd]); }, 'rounding a year Duration fails without largest/smallest unit');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$duration2, &$pd) { $duration2->round((object) ['relativeTo' => $pd]); }, 'rounding a month Duration fails without largest/smallest unit');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$duration3, &$pd) { $duration3->round((object) ['relativeTo' => $pd]); }, 'rounding a week Duration fails without largest/smallest unit');
...
Assert::throws(\InvalidArgumentException::class, function () use (&$duration4, &$pd) { $duration4->round((object) ['relativeTo' => $pd]); }, 'rounding a day Duration fails without largest/smallest unit');
