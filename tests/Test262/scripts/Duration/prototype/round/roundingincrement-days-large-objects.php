...
$result = $duration1->round((object) ['smallestUnit' => 'days', 'roundingIncrement' => 10_000_000, 'relativeTo' => $relativeTo]);
...
foreach ($relativeToTests as $__entry__) {
[$relativeTo, $descr] = array_pad($__entry__, 2, null);
$result = $duration2->round((object) ['smallestUnit' => 'days', 'roundingIncrement' => 100_000_000 - 1, 'roundingMode' => 'ceil', 'relativeTo' => $relativeTo]);
