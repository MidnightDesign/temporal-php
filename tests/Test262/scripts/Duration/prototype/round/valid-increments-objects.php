...
$options = (object) ['smallestUnit' => 'hours', 'roundingIncrement' => $roundingIncrement, 'relativeTo' => $relativeTo];
...
$roundTo = (object) ['smallestUnit' => $smallestUnit, 'roundingIncrement' => $roundingIncrement, 'relativeTo' => $relativeTo];
