...
$result = $d->add((object) JsUndefined::strip(['microseconds' => 9_007_199_254_740_991 - 1]));
...
Assert::sameValue(\Temporal\Spec\Duration::compare($result->add((object) ['microseconds' => 1]), $result), 0, 'subsequent add() should not use more precise internal representation than the spec prescribes');
