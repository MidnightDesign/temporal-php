...
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Now::plainDateTimeISO($timeZone), 'bare date-time string is not a time zone');
...
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Now::plainDateTimeISO($timeZone), "ISO string {$timeZone} with a sub-minute offset is not a valid time zone");
}
