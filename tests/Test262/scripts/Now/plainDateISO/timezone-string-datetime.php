...
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Spec\Now::plainDateISO($timeZone), 'bare date-time string is not a time zone');
...
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Spec\Now::plainDateISO($timeZone), "ISO string {$timeZone} with a sub-minute offset is not a valid time zone");
}
