...
Assert::throws(\InvalidArgumentException::class, function () use (&$timeZone) { return \Temporal\Spec\Now::zonedDateTimeISO($timeZone); }, 'leap second in time zone name not valid');
