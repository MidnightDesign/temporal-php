...
Assert::throws((is_string($timeZone) ? \InvalidArgumentException::class : \TypeError::class), fn() => \Temporal\Spec\Now::zonedDateTimeISO($timeZone), "{$description} does not convert to a valid ISO string");
}
