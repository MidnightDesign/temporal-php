...
Assert::throws((is_string($timeZone) ? \InvalidArgumentException::class : \TypeError::class), function () use (&$timeZone) { return \Temporal\Spec\Now::zonedDateTimeISO($timeZone); }, "{$description} does not convert to a valid ISO string");
}
