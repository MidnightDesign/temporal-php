...
Assert::throws(\RangeException::class, function () use (&$timeZone) { return \Temporal\Spec\Now::zonedDateTimeISO($timeZone); }, 'bare date-time string is not a time zone');
...
Assert::throws(\RangeException::class, function () use (&$timeZone) { return \Temporal\Spec\Now::zonedDateTimeISO($timeZone); }, "ISO string {$timeZone} with a sub-minute offset is not a valid time zone");
}
