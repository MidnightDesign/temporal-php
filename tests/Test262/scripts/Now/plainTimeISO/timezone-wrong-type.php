...
Assert::throws((is_string($timeZone) ? \InvalidArgumentException::class : \TypeError::class), function () use (&$timeZone) { return \Temporal\Spec\Now::plainTimeISO($timeZone); }, "{$description} does not convert to a valid ISO string");
}
