...
$isoDayExplicit = (float) (\Temporal\Tests\Test262\Js::slice($dateExplicit->toString(['calendarName' => 'always'])->split('-')[2], 0, 2));
Assert::sameValue($isoDayExplicit, 1, 'default referenceISODay is 1');
$dateImplicit = new \Temporal\Spec\PlainYearMonth(...$args);
$isoDayImplicit = (float) (\Temporal\Tests\Test262\Js::slice($dateImplicit->toString(['calendarName' => 'always'])->split('-')[2], 0, 2));
