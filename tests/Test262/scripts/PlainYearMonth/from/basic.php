...
$result = \Temporal\Spec\PlainYearMonth::from(['year' => 2021, 'month' => 7]);
TemporalHelpers::assertPlainYearMonth($result, 2021, 7, 'M07', 'year 2021, month 7');
$result = \Temporal\Spec\PlainYearMonth::from(['year' => 2021, 'month' => 12]);
TemporalHelpers::assertPlainYearMonth($result, 2021, 12, 'M12', 'year 2021, month 12');
$result = \Temporal\Spec\PlainYearMonth::from(['year' => 2021, 'monthCode' => 'M07']);
TemporalHelpers::assertPlainYearMonth($result, 2021, 7, 'M07', 'year 2021, monthCode M07');
$result = \Temporal\Spec\PlainYearMonth::from(['year' => 2021, 'monthCode' => 'M12']);
