...
$plainYearMonth = \Temporal\PlainYearMonth::from($propertyBag, ['overflow' => 'constrain']);
TemporalHelpers::assertPlainYearMonth($plainYearMonth, 2000, 12, 'M12', 'default overflow is constrain');
$opt = ['overflow' => 'constrain'];
$result = \Temporal\PlainYearMonth::from(['year' => 2021, 'month' => 1], $opt);
...
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\PlainYearMonth::from(['year' => 2021, 'month' => -99_999], $opt), 'negative month -99999 is out of range even with overflow constrain');
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\PlainYearMonth::from(['year' => 2021, 'month' => -1], $opt), 'negative month -1 is out of range even with overflow constrain');
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\PlainYearMonth::from(['year' => 2021, 'month' => 0], $opt), 'month zero is out of range even with overflow constrain');
...
$result = \Temporal\PlainYearMonth::from(['year' => 2021, 'month' => 99_999], $opt);
