...
Assert::throws(\InvalidArgumentException::class, function () use (&$arg) { return \Temporal\Spec\PlainYearMonth::from($arg); }, "annotation keys must be lowercase: {$arg} - {$descr}");
}
