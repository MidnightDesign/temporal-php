...
Assert::throws(\InvalidArgumentException::class, function () use (&$options) { \Temporal\Spec\PlainYearMonth::from(['year' => 2025, 'monthCode' => 'M08L'], $options); }, 'exception thrown when month code is invalid for calendar');
