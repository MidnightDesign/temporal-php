...
$explicit = \Temporal\Spec\PlainYearMonth::from($value, (object) []);
TemporalHelpers::assertPlainYearMonth($explicit, 2000, 5, 'M05', 'overflow is ignored');
$implicit = \Temporal\Spec\PlainYearMonth::from($value, (object) []);
...
$explicit = \Temporal\Spec\PlainYearMonth::from($propertyBag, (object) []);
TemporalHelpers::assertPlainYearMonth($explicit, 2000, 12, 'M12', 'default overflow is constrain');
$implicit = \Temporal\Spec\PlainYearMonth::from($propertyBag, (object) []);
