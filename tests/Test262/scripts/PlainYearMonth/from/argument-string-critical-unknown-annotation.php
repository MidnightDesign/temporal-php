...
Assert::throws(\InvalidArgumentException::class, function () use (&$arg) { return \Temporal\Spec\PlainYearMonth::from($arg); }, "reject unknown annotation with critical flag: {$arg}");
}
