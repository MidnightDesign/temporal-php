...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Temporal\Spec\PlainYearMonth::from($arg); }, "\"{$arg}\" UTC offset without time is not valid for PlainYearMonth");
}
