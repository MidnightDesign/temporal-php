...
Assert::throws(\InvalidArgumentException::class, fn() => \Temporal\Spec\PlainYearMonth::from((object) ['year' => 2019, 'month' => 11, 'monthCode' => 'M12']), 'Mismatch between month and monthCode');
