...
$instance = new \Temporal\PlainYearMonth(-100_000, 12);
Assert::sameValue($instance->toString(), '-100000-12', 'large negative year formatted as 6-digit');
$instance = new \Temporal\PlainYearMonth(-10_000, 4);
