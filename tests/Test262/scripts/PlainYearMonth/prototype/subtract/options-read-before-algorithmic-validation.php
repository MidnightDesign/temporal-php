...
Assert::throws(\InvalidArgumentException::class, function () use (&$instance, &$options) { $instance->subtract(new \Temporal\Spec\Duration(0, -1), $options); }, 'exception thrown when converting -271821-04 to date');
