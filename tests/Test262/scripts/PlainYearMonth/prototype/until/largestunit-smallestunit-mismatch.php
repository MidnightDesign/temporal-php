...
Assert::throws(\InvalidArgumentException::class, function () use (&$earlier, &$later, &$largestUnit, &$smallestUnit) { return $earlier->until($later, ['largestUnit' => $largestUnit, 'smallestUnit' => $smallestUnit]); }, '');
}
}
