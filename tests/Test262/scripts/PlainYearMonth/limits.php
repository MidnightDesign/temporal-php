...
Assert::throws(\RangeException::class, fn() => new \Temporal\Spec\PlainYearMonth(-271_821, 3), 'min');
Assert::throws(\RangeException::class, fn() => new \Temporal\Spec\PlainYearMonth(275_760, 10), 'max');
