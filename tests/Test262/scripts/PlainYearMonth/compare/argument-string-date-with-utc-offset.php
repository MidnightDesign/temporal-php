...
$result = \Temporal\Spec\PlainYearMonth::compare($arg, $arg);
...
Assert::throws(\RangeException::class, function () use (&$arg) { return \Temporal\Spec\PlainYearMonth::compare($arg, new \Temporal\Spec\PlainYearMonth(2019, 6)); }, "\"{$arg}\" UTC offset without time is not valid for PlainYearMonth (first argument)");
Assert::throws(\RangeException::class, function () use (&$arg) { return \Temporal\Spec\PlainYearMonth::compare(new \Temporal\Spec\PlainYearMonth(2019, 6), $arg); }, "\"{$arg}\" UTC offset without time is not valid for PlainYearMonth (second argument)");
}
