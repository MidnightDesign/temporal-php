...
Assert::throws(\TypeError::class, function () use (&$jun13) { return \Temporal\Spec\PlainYearMonth::compare(['year' => 1994], $jun13); }, 'one missing property');
...
Assert::throws(\TypeError::class, function () use (&$nov94) { return \Temporal\Spec\PlainYearMonth::compare($nov94, ['year' => 2013]); }, 'two missing property');
