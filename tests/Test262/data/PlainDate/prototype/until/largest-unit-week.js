...
description: until() with largestUnit: "week" breaks result into weeks and days
features: [Temporal]
---*/
...
const result = d1.until(d2, { largestUnit: "week" });
...
const result2 = d1.until(d3, { largestUnit: "week" });
