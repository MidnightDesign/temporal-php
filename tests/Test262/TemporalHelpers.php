...
final class TemporalHelpers
{
    ...
    // -------------------------------------------------------------------------
    // ISO string-array helpers
    //
    // PHP ports of the TemporalHelpers.ISO.* methods defined in the TC39
    // test262 harness (harness/temporalHelpers.js). Arrays are copied verbatim
    // from upstream and must not be modified.
    // -------------------------------------------------------------------------
